...
class LochLomondEnv(discrete.DiscreteEnv):
    ...
    Winter has arrived in Scotland. You and your friends were tossing around a frisbee at Loch Lomond
    ...
    def __init__(self, problem_id=0, map_name_base="8x8-base", is_stochastic=True, reward_hole=0.0, reward=1.0):
        if reward_hole > 0.0:
            raise ValueError('reward_hole must be equal or less than 0')
        ...
        self.reward = reward
        self.path_cost = 0.0  # you should not change this !
        ...
        self.reward_range = (reward_hole, 1)
    ...
    def render(self, mode='human'):
        ...
        desc[row][col] = utils.colorize(desc[row][col], "red",
                                        highlight=True)  # note: this does not work on all setups you can try to uncomment asnd see what happends (if it does work you'll see weird symbols)
